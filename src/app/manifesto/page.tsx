                ...
                <CyberContainer className="flex flex-col gap-8 row-start-2 items-center sm:items-start">
                    <div
                        ...
                        <CyberContainer className={"text-center text-base p-2 m-4 w-auto h-auto"}>
                            ...
                            As farmácias, a ciência, a internet e seus resultados devem servir o povo e não a lógica de
                            lucro.
                            <br/><br/>
                            Liberdade é ter acesso ao básico para poder viver. Um corpo com fome e sem moradia não pode
                            ter autonomia até suas necessidades serem atendidas.
                            Enquanto isso, nosso mundo produz excesso para poucos bilionários através da escassez
                            induzida para muitos. Essa é a contradição do Cistema* em que vivemos.
                            <br/><br/>
                            Excesso para bilionários com riquezas colossais versus a falta de alimento para matar a
                            fome, moradia para viver, fármacos e técnicas para podermos afirmar o corpo desejado e uma
                            internet livre que incentive a colaboração ao invés do consumo.
                            Nossos corpos são atravessados por essa contradição, sendo os corpos trans, com deficiência,
                            ...
                            <br/><br/>
                            É da necessidade causada pela escassez induzida pela classe dominante que garante que 1%
                            ...
                            moradia e comunidade para sermos livres, em resumo, das faltas das necessidades básicas
                            atendidas por essa sociedade, que nasce este coletivo.
                        ...
                        <CyberContainer className="text-center text-base p-2 m-4 w-auto h-auto">
                            ...
                            marginalizados pelo Cistema depende de uma ruptura radical das estruturas que nos excluem.
                        ...
                        <CyberContainer className="text-center text-base p-2 m-4 w-auto h-auto">
                            ...
                            comunidades como forma de cultivar a cooperação sem a dependência de uma estrutura
                            mercadológica, estatal ou partidária para garantir a organização.
                            <br/><br/>
                            Buscamos uma sociedade em que a autonomia corporal seja plena, portanto desejamos a total
                            descentralização do poder econômico, político e a extinção da noção genitalista cishétero de
                            conformidade entre genital-gameta e identidade, construímos alianças com comunidades e
                        ...
                        <CyberContainer className="text-center text-base p-2 m-4 w-auto h-auto">
                            ...
                            “De cada um de acordo com sua capacidade”. Seguimos essa máxima, pois o mundo capitalista
                            consome grande parte do nosso tempo e capacidades, precisamos antes sobreviver para lutar.
                            <br/><br/>
                            ...
                            Construímos em coletivo. Acreditamos que a cooperação organizada com habilidades distintas
                            nos leva mais longe.
                        </CyberContainer>
                        ...
                        <CyberContainer className="text-center text-base p-2 m-4 w-auto h-auto">
                            ...
                            “Para cada um de acordo com a sua necessidade”. Trabalhamos coletivamente para fortalecer
                            nossa comunidade como base para uma experiência social capaz de atender nossas necessidades.
                            <br/><br/>
                            Nosso objetivo é uma comunidade horizontal em que todos participem das decisões e colham os
                            frutos delas ao mesmo tempo que a constroem juntos.
                            Faremos ação direta, usando nosso trabalho para contribuir com a comunidade sem depender do
                        ...
                        <CyberContainer className="text-center text-base p-2 m-4 w-auto h-auto">
                            ...
                            diferentes podem entrar em relação” (McKenzie Wark). Nossa arte produz relações.
                            ...
                            instrumento de luta muito importante. Ela é capaz de produzir memória, ancestralidade e
                            perspectivas de novos mundos.
                            ...
                            <br/><br/>
                            No mundo virtual, toda interface feita por nós será feita para produzir relações que
                            constroem coletividade e resistência da nossa comunidade. Não recuaremos diante do roubo
                            feito pelas big techs das artes no território da internet. As Inteligências Artificiais têm
                            sido usadas para se apropriar do trabalho artístico e gerar lucro para bilionários.
                            Mostraremos a verdadeira potência da IA e da arte marginalizada, colocando suas tecnologias
                        ...
                        <CyberContainer className="text-center text-base p-2 m-4 w-auto h-auto">
                            ...
                            Cisgenereidade é compulsória! O presente é apenas potencial e o futuro é a realização ou
                            contenção dele. Rejeitamos a perspectiva fatalista cisheteronormativa em que tudo que somos
                            é um produto “biológico” determinado por nossas genitais ou gametas fechado em uma
                            possibilidade binária.
                            <br/><br/>
                            Um corpo tem infinitas possibilidades de existir, que hoje estão limitadas pela falta de
                            acesso às técnicas de modificação corporal e pela obrigação imposta de gerar filhos.
                            Queremos libertar essas potências para além do binário e do gênero como limitantes.
                            <br/><br/>
                            Desejamos libertar nossos afetos para além da heterossexualidade que existe para servir à
                            reprodução compulsória de mão-de-obra para o capitalismo.
                            Temos que parar de falar da revolução em termos de futuro, esse peso no futuro atribui o
                            processo revolucionário somente ao processo de classe. O que corpos trans fazem e resistem
                            já é por si uma revolução.
                        ...
                        <CyberContainer className="text-center text-base p-2 m-4 w-auto h-auto">
                            ...
                            Não existe liberdade onde se tem fome. Faltam oportunidades para pessoas trans, com
                            deficiência e neurodivergentes poderem matar sua fome. Enquanto isso, há supermercados
                            cheios com preços inacessíveis, porque o Cistema produz a comida para dar lucro e não para
                            matar fome.
                            <br/><br/>
                        ...
                        <CyberContainer className="text-center text-base p-2 m-4 w-auto h-auto">
                            ...
                            Não existe liberdade sem ter um teto. Precisamos morar. Os corpos marginalizados são negados
                            o direito de ter um abrigo em um lar próprio, somos expulsos de nossas casas e desacolhidos
                            pelo Estado e o mercado.
                            <br/><br/>
                            A moradia para nossos corpos não está contemplada por essas lógicas, que produz casas sem
                            pessoas e pessoas sem casas. Nossa comunidade é uma das mais afetadas por essa escassez
                            produzida para dar lucro.
                            Por isso, lutamos por uma lógica de propriedade que permita que ninguém morra de frio nas
                            ruas.
                        ...
                        <CyberContainer className="text-center text-base p-2 m-4 w-auto h-auto">
                            ...
                            Corpos são políticos! Não tirem nossos corpos de nós. Homem e mulher é um produto da
                            cisgenerificação compulsória. Próteses, fármacos e procedimentos estéticos de afirmação de
                            gênero são livres para pessoas cis e restringidos para pessoas trans. Isso é uma
                            consequência direta do Cistema, dependente da linha de produção de proles (filhos) para
                            servirem de mão-de-obra barata e consumidor.
                            <br/><br/>
                            Queremos o fim disso tudo.
                            <br/><br/>
                            A descentralização das tecnologias de modificação corporal depende do fim do capitalismo e
                            do patriarcado. Portanto, defendemos a propriedade coletiva de todos meios de produção e
                            reprodução da vida, de construção corporal e da consciência como das terras onde a comida
                        ...
                        <CyberContainer className="text-center text-base p-2 m-4 w-auto h-auto">
                            ...
                            fluxo dessa informação se mantém oculto por trás dos algoritmos dominados por big techs,
                            ...
                            <br/><br/>
                            A centralização da internet em pouquíssimos sites e apps desses bilionários destruiu as
                            formas descentralizadas antes conhecidas de blogs, sites, fóruns em que as cibercomunidades
                            tinham autonomia para construir seus ciberespaços sem ter seus dados roubados por algoritmos
                            que servem à ganância de bilionários digitais.
                            <br/><br/>
                            Queremos uma internet livre, descentralizada, em que os algoritmos sejam abertos,
                            transparentes, programados por nós e atuando para incentivar a colaboração para atender as
                            necessidades das pessoas e não para espalhar mentiras (fake news) ou incentivar uma cultura
                            de consumo. Devemos ter controle da interface e dos meios de produzi-la.
                            <br/><br/>
                            ...
                            Também acreditamos na possibilidade de se construir um corpo através de um espaço
                            extracorporal, uma simulação do que se é/ou se deseja ser na virtualização do ser. Não
                            hierarquizamos e definimos a linha que traça a distinção entre os espaços materiais e os
                            virtuais.
                            <br/><br/>
                            Por isso, disputaremos a internet como forma de produzir a si próprio, construindo e
                        ...
                        <CyberContainer className="text-center text-base p-2 m-4 w-auto h-auto">
                            ...
                            Neurodivergência não é patologia, patológico é um sistema que lê as diferenças como doença.
                            ...
                            <br/><br/>
                            Queremos libertar as mentes destes fármacos. Fármacos devem atender as necessidades
                            individuais e coletivas e não do sistema capitalista para manter a lógica de produção de
                            lucro.
                            <br/><br/>
                            Lutamos pelo livre acesso aos fármacos e pelo fim de uma lógica de trabalho adoecedora que
                        ...
                        <CyberContainer className="text-center text-base p-2 m-4 w-auto h-auto">
                            ...
                            Se um corpo pode vir de nós, então somos nossos próprios mestres. A tecnologia nos
                            possibilitou hackear nossos corpos para reproduzirmos sem depender da heterossexualidade.
                            Essas tecnologias são restringidas pelo tecnopatriarcado para poucos. Ter filhos deve ser
                            uma possibilidade e escolha para qualquer corpo através das tecnologias de reprodução.
                            <br/><br/>
