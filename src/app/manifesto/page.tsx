                ...
                <CyberContainer className="flex flex-col gap-8 row-start-2 items-center sm:items-start">
                    <div
                        ...
                        <CyberContainer className={"text-center text-base p-2 m-4 w-auto h-auto"}>
                            ...
                            <CyberTooltip word="Cistema*" description="Consultar glossário no final da página para mais informações do que é o Cistema"/>. </b></p>
                            Construiremos um mundo onde toda pessoa será livre para construir e viver o seu corpo desejado.
                            Desejamos o domínio e livre acesso à produção e uso das tecnologias de afirmação do corpo e da mente.
                            ...
                            <b> As farmácias, a ciência, a internet e seus resultados devem servir a todos, não a lógica de
                            lucro.</b>
                            <br/><br/>
                            ...
                            fome, moradia para viver, fármacos</b> e técnicas para podermos <b>afirmar o corpo desejado</b> e uma
                            ...
                            <br/><br/>
                            É da necessidade causada pela <b>escassez induzida pela classe dominante</b> que garante que 1%
                        ...
                        <CyberContainer className="text-center text-base p-2 m-4 w-auto h-auto">
                            ...
                            <CyberTooltip word="tecnologias de produção do corpo*" description="Consultar glossário no final da página para mais informações do que são essas tecnologias"/> estejam nas mãos das pessoas
                            marginalizadas pelo Cistema depende de uma ruptura radical das estruturas que nos excluem do controle dessas tecnologias.
                        ...
                        <CyberContainer className="text-center text-base p-2 m-4 w-auto h-auto">
                            ...
                            <CyberTooltip word="vanguardas*" description="Consultar glossário no final da página para mais informações do que entendemos por vanguarda"/>. 
                            Acreditamos na construção e organização das comunidades como forma de cultivar a cooperação sem a dependência de uma estrutura
                            ...
                            conformidade entre genital-gameta e identidade</b>, construímos alianças com comunidades e
                        ...
                        <CyberContainer className="text-center text-base p-2 m-4 w-auto h-auto">
                            ...
                            <b>“De cada um de acordo com sua capacidade”</b>. Seguimos essa máxima, pois o mundo capitalista
                            consome grande parte do nosso tempo e capacidades, <b>precisamos antes sobreviver para lutar.</b>
                            <br/><br/>
                            ...
                            <b> Construímos em coletivo</b>. Acreditamos que a cooperação organizada com habilidades distintas
                            nos leva mais longe.
                        </CyberContainer>
                        ...
                        <CyberContainer className="text-center text-base p-2 m-4 w-auto h-auto">
                            ...
                            <b>“Para cada um de acordo com a sua necessidade”</b>. Trabalhamos coletivamente para fortalecer
                        ...
                        <CyberContainer className="text-center text-base p-2 m-4 w-auto h-auto">
                            ...
                            constroem coletividade e resistência da nossa comunidade</b>. Não recuaremos diante do roubo
                        ...
                        <CyberContainer className="text-center text-base p-2 m-4 w-auto h-auto">
                            ...
                            contenção dele. </b> Rejeitamos a perspectiva fatalista cisheteronormativa em que tudo que somos
                            ...
                            domínio às técnicas de modificação corporal e pela obrigação imposta de gerar filhos. </b>
                            Queremos libertar essas potências para além do binário e do gênero como limitantes.
                            <br/><br/>
                            Desejamos <b>libertar nossos afetos para além da cisheterossexualidade</b> que existe para servir à
                            reprodução compulsória de mão-de-obra para o capitalismo.
                            <b> Precisamos parar de falar da revolução em termos de futuro, esse peso no futuro atribui o
                        ...
                        <CyberContainer className="text-center text-base p-2 m-4 w-auto h-auto">
                            ...
                            cheios com preços inacessíveis</b>, porque o Cistema produz a comida para dar lucro e não para
                            matar fome.
                            <br/><br/>
                        ...
                        <CyberContainer className="text-center text-base p-2 m-4 w-auto h-auto">
                            ...
                            <CyberSpeech>
                                <b>Saúde é para garantir autonomia e não só para tratar sintomas.</b> Queremos livre acesso a
                            ...
                            <div className="whitespace-pre-wrap">
                                <b>Precisamos de pessoas trans, neurodivergentes e pessoas com deficiência participando da
                                produção da sua própria saúde como agentes ativos </b>de uma saúde buscando aumentar o
                                ...
                                sintomas dos adoecimentos causados por ele com a finalidade de nos tornar mais produtivos e não nos dar
                                autonomia. 
                            <br/><br/>
                        ...
                        <CyberContainer className="text-center text-base p-2 m-4 w-auto h-auto">
                            ...
                            <b>Não existe liberdade sem ter um teto</b>. Precisamos morar. Os corpos marginalizados são negados
                            o direito de ter um <b>abrigo</b> em um <b>lar próprio</b>, somos expulsos de nossas casas e desacolhidos
                            pelo Estado e o mercado.
                            <br/><br/>
                            A moradia para nossos corpos não está contemplada por essas lógicas, que produz<b> {''}
                            <CyberTooltip word="casas sem pessoas e pessoas sem casas" description="Censo 2022: imóveis desocupados representam 12 vezes a população de rua da cidade de SP" /></b>. Nossa comunidade é uma das mais afetadas por essa escassez
                        ...
                        <CyberContainer className="text-center text-base p-2 m-4 w-auto h-auto">
                            ...
                            reprodução da vida, de construção corporal e da consciência</b> como das terras onde a comida
                        ...
                        <CyberContainer className="text-center text-base p-2 m-4 w-auto h-auto">
                            ...
                            formas descentralizadas</b> antes conhecidas de blogs, sites, fóruns em que as cibercomunidades
                            tinham <b>autonomia para construir seus ciberespaços</b> sem ter seus dados roubados por algoritmos
                            ...
                            necessidades das pessoas</b> e não para espalhar mentiras (fake news) ou incentivar uma cultura
                        ...
                        <CyberContainer className="text-center text-base p-2 m-4 w-auto h-auto">
                            ...
                            <b>Neurodivergência não é patologia, patológico é um sistema que lê as diferenças como doença.</b> 
                            ...
                            lucro.</b>
                            <br/><br/>
                            Lutamos pelo <b>livre acesso e domínio dos fármacos</b>, pelo <b>fim de uma lógica de trabalho adoecedora</b> que
                        ...
                        <CyberContainer className="text-center text-base p-2 m-4 w-auto h-auto">
                            ...
                            em nossas mãos, a <b>cisheterossexualidade deixa de ter sentido na sua existência, justificada
                        ...
                        <p><b>Cistema</b>: Chamamos de Cistema o mundo que vivemos hoje. O mundo de hoje é feito de barreiras que restringem acessos. <p>- O <b>capitalismo</b> restringe acesso ao trabalho, à moradia, à comida e tudo que produzimos para concentrar riqueza nas mãos da minoria da população. </p>- <b>O binarismo e a cisheterossexualidade</b> restringem nossa técnica e imaginação para além das dualidades homem x mulher; <p>- O <b>Estado</b> nos restringe das decisões que podem mudar essa realidade ao nos reprimir com a polícia e tomar as decisões através de políticos que não nos representam;</p><p> - O <b>vetorialismo</b> - sistema em que uma classe domina os meios de produção de informação e fluxos de comunicação - restringe as informações e nos direciona informações falsas e manipuladas para nos convencer das inverdades da classe dominante.</p>
                        <b>A soma dessas estruturas é o Cistema.</b></p>
                        <br></br>
                        <p><b>Tecnologias de produção do corpo</b>: Entendemos qualquer técnica e trabalho usado para produzir os corpos para viverem em sociedade hoje como ‘Tecnologias de produção do corpo’. </p> <p>Por exemplo: Produtos de higiene, comida, moradia, hormônios, remédio, fármacos, roupas, cirurgias são todos produzidos pelo trabalho coletivo de várias pessoas, empregando tecnologias como química, biologia, medicina etc.
                        </p>
                        <br></br>
                        <b>Vanguardas</b>: entendemos por vanguardas, grupos políticos que pretendem controlar o processo revolucionário, tomando as decisões pelo povo, e que se pretendem como mais esclarecidas do que qualquer outro grupo político em relação ao processo de ruptura com o Cistema.
