    ...
    return (
        <>
            <CyberContainer className="min-h-screen flex flex-col items-center overflow-x-hidden px-4 py-8">
                <CyberContainer className="p-4 text-accent1 sm:p-8 break-words tracking-wide w-full max-w-4xl">
                    ...
                    <CyberContainer className="text-center text-base p-2 m-4 w-auto h-auto">
                        ...
                        e grupos que reforçam este projeto.
                        <br /><br />
                    ...
                    <CyberContainer className="text-center text-base p-2 m-4 w-auto h-auto">
                        ...
                        <b> Construímos em coletivo</b>. Acreditamos que a cooperação organizada com habilidades
                        distintas
                        nos leva mais longe.
                    </CyberContainer>
                    ...
                    <CyberContainer className="text-center text-base p-2 m-4 w-auto h-auto">
                        ...
                        <b>Cisgenereidade é compulsória! O presente é apenas potencial e o futuro é a realização ou
                            contenção dele. </b> Rejeitamos a perspectiva fatalista cisheteronormativa em que tudo
                        que somos
                        ...
                        <b> Precisamos parar de falar da revolução em termos de futuro, esse peso no futuro atribui
                            o
                    ...
                    <CyberContainer className="text-center text-base p-2 m-4 w-auto h-auto">
                        ...
                        <div className="whitespace-pre-wrap">
                            ...
                            <CyberTooltip
                                word="Cistema"
                                description="Bando de cuzões. ex: Elon Musk"
                                link="#cistema"
                            />, que só
                            trata os
                    ...
                    <CyberContainer className="text-center text-base p-2 m-4 w-auto h-auto">
                        ...
                        A moradia para nossos corpos não está contemplada por essas lógicas, que produz<b> {''}
                            <CyberTooltip
                                word="casas sem pessoas e pessoas sem casas"
                                description="Censo 2022: imóveis desocupados representam 12 vezes a população de rua da cidade de SP"
                            /></b>.
