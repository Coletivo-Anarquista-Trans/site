...
a minha vida é luta, e vai ser até o final! laroyê! </p>
  ...
  },
  {
    ...
    content: `
      <h2>Sobre o CFM</h2>
      <p>Mais uma vez o Conselho Federal de Medicina decidiu “legislar”, através de suas normativas, sobre os corpos trans com a desculpa de estar fazendo “saúde”, mesmo que nenhuma pessoa trans participe dessas decisões.
...
O que está demonstrado é a classe médica se posicionando na ala mais conservadora e anti-trans junto da extrema-direita brasileira, apontando para a necessidade de também estarmos conectados para evitar mais restrições sobre nossos corpos.
